  ...
  return (
    <aside className={`form-card rounded-2xl bg-app-card-soft p-6 ${compact ? "xl:max-w-[349px]" : ""}`}>
      ...
      <dl className="mt-7 space-y-5 text-sm">
        ...
        <div className="flex items-center justify-between"><dt className="text-app-muted-light">رقم المرجع</dt><dd className="text-app-text">98865654</dd></div>
        <div className="flex items-center justify-between"><dt className="text-app-muted-light">التاريخ</dt><dd className="text-app-text">2025/54/65</dd></div>
        <div className="flex items-center justify-between"><dt className="text-app-muted-light">المستخدم</dt><dd className="text-app-text">محمد الاسعد</dd></div>
