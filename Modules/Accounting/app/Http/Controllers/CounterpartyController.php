    ...
    #[OA\RequestBody(
        ...
        content: new OA\JsonContent(
            ...
            properties: [
                ...
                new OA\Property(property: 'phone', type: 'string', description: 'رقم هاتف الطرف', nullable: true, example: '+966509998887'),
    ...
    #[OA\RequestBody(
        ...
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(property: 'phone', type: 'string', description: 'رقم هاتف التواصل الجديد', nullable: true, example: '+966509998887'),
