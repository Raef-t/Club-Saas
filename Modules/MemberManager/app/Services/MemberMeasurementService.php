...
use Modules\MemberManager\Repositories\MemberMeasurementRepositoryInterface;

class MemberMeasurementService
{
    protected $repository;

    public function __construct(MemberMeasurementRepositoryInterface $repository) {
