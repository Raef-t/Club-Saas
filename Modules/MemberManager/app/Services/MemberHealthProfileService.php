...
use Modules\MemberManager\Repositories\MemberHealthProfileRepositoryInterface;

class MemberHealthProfileService
{
    protected $repository;

    public function __construct(MemberHealthProfileRepositoryInterface $repository) {
