...
use Modules\SubscriptionManager\Repositories\SubscriptionFreezeRepositoryInterface;

class SubscriptionFreezeService
{
    protected $repository;

    public function __construct(SubscriptionFreezeRepositoryInterface $repository) {
