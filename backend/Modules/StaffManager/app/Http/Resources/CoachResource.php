    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'person'         => $this->person ? [
                ...
                'phone_number' => ($this->person->contacts->first(fn($c) => $c->relation === 'self' || $c->name === 'Personal') ?? $this->person->contacts->first())?->phone_number,
                'country_code' => ($this->person->contacts->first(fn($c) => $c->relation === 'self' || $c->name === 'Personal') ?? $this->person->contacts->first())?->country_code,
            ] : null,
