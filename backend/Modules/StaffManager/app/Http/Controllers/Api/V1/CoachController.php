...
class CoachController extends BaseController
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'name', in: 'query', required: false, description: 'بحث باسم الكوتش', schema: new OA\Schema(type: 'string', example: 'أحمد')),
            new OA\Parameter(name: 'employment_type', in: 'query', required: false, description: 'تصفية حسب نوع التوظيف (fixed_salary: راتب، commission_based: نسبة، hybrid: نسبة وراتب)', schema: new OA\Schema(type: 'string', enum: ['fixed_salary', 'commission_based', 'hybrid', 'راتب', 'نسبة', 'نسبة وراتب'])),
