...
class StoreSubscriptionPlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'duration_days' => 'required_if:type,fixed_period|prohibited_if:type,session_based|nullable|integer|min:1',
            'session_count' => 'required_if:type,session_based|prohibited_if:type,fixed_period|nullable|integer|min:1',
