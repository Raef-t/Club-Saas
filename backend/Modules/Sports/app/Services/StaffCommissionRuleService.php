...
use Modules\Sports\Repositories\StaffCommissionRuleRepositoryInterface;

class StaffCommissionRuleService
{
    protected $repository;

    public function __construct(StaffCommissionRuleRepositoryInterface $repository) {
